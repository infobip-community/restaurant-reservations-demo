export const OAUTH_ACTIVE = process.env.REACT_APP_OAUTH_ACTIVE === 'true';
...
export const CONVERSATIONS_INTEGRATION_ENABLED = process.env.REACT_APP_CONVERSATIONS_INTEGRATION === 'true';
